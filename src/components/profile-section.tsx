      ...
      <div className="w-2/3 md:w-full">
        ...
        <p className="text-zinc-600 text-xs leading-relaxed tracking-wide uppercase mb-6">
          ...
          {aboutMe.institutionUrl ? (
            <a
              ...
              className="hover:text-stanford-red transition-colors duration-300"
              target="_blank"
        ...
        <div className="flex gap-6 mb-6">
          {aboutMe.blogUrl && (
            <a
              ...
              className="group inline-flex items-center gap-2 text-xs text-zinc-500 hover:text-stanford-red transition-colors duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
              <ArrowUpRight
        ...
        <div className="space-y-2">
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-zinc-600 hover:text-stanford-red transition-colors"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Mail size={14} />
